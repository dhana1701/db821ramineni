...
res.render('index', { title: 'technology App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'technology App Registration'});
});
...
res.render('login', { title: 'technology App Login', user : req.user });
});
